...
namespace RPC_MPI
{
    ...
    void Send(const unsigned char code, const void* data,const unsigned int length)
    {
        if(code==SERIAL_OUT)
        {
            Print((char*)data,length);
            return;
        }
