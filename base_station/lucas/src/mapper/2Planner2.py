#!/usr/bin/env python3
"""
CSV-based LiDAR simulation with doorway detection and path planning
Press 'n' to load next CSV scan, 'q' to quit.
"""
...
USE_CSV_FILE = True
CSV_FOLDER = "scans"
ULTIMATE_GOAL = ((-5.267200469970703/1000),(451.8113708496094/1000))
...
shared = {"occupancy_map": None, "center_x": None, "center_y": None,
          "min_x": None, "min_y": None, "raw_candidates": [], "clustered_doors": []}
...
def csv_worker_loop(csv_folder, user_next_event):
    ...
    while True:
        ...
        if not os.path.exists(csv_path):
            print(f"No more scans found after {scan_index-1} files.")
...
def main():
    ...
    while True:
        ...
        # Pick the first detected doorway or fallback goal
        if clustered:
            gx, gy, mx, my, gap = clustered[0]
        else:
